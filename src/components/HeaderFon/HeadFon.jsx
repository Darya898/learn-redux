...
import icon4 from '../../assets/header-img/fon/1_4.png'
import icon5 from '../../assets/header-img/fon/1_5.png'
import icon6 from '../../assets/header-img/fon/1_6.png'
import icon7 from '../../assets/header-img/fon/1_7.png'
import icon8 from '../../assets/header-img/fon/1_8.png'
import icon9 from '../../assets/header-img/fon/1_9.png'
import icon2_1 from '../../assets/header-img/fon/2_1.png'
import icon2_2 from '../../assets/header-img/fon/2_2.png'
import icon2_3 from '../../assets/header-img/fon/2_3.png'
import icon2_4 from '../../assets/header-img/fon/2_4.png'
import icon2_5 from '../../assets/header-img/fon/2_5.png'
import icon2_6 from '../../assets/header-img/fon/2_6.png'
import icon2_7 from '../../assets/header-img/fon/2_7.png'
import icon2_8 from '../../assets/header-img/fon/2_8.png'
import icon2_9 from '../../assets/header-img/fon/2_9.png'
import icon3_1 from '../../assets/header-img/fon/3_1.png'
import icon3_2 from '../../assets/header-img/fon/3_2.png'
import icon3_3 from '../../assets/header-img/fon/3_3.png'
import icon3_4 from '../../assets/header-img/fon/3_4.png'
import icon3_5 from '../../assets/header-img/fon/3_5.png'
import icon3_6 from '../../assets/header-img/fon/3_6.png'
import icon3_7 from '../../assets/header-img/fon/3_7.png'
import icon3_8 from '../../assets/header-img/fon/3_8.png'
import icon3_9 from '../../assets/header-img/fon/3_9.png'
import icon4_1 from '../../assets/header-img/fon/4_1.png'
import icon4_2 from '../../assets/header-img/fon/4_2.png'
import icon4_3 from '../../assets/header-img/fon/4_3.png'
import icon4_4 from '../../assets/header-img/fon/4_4.png'
import icon4_5 from '../../assets/header-img/fon/4_5.png'
import icon4_6 from '../../assets/header-img/fon/4_6.png'
import icon4_7 from '../../assets/header-img/fon/4_7.png'
...
const HeadFon = () => {
    return (
        <div className={styles.wrapper}>
            <div className={styles['wrapper-fon']}></div>
